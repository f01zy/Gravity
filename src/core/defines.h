...
#define WORLD_SCALE_COEFFICIENT (10.0f)
#define TIME_SCALE              (100000.0f)
#define TIME_SCALE_SPEED        (1000.0f)
#define MAX_TIME_SCALE          (1000000.0f)
#define PRESS_TIMER             (100.0f)
#define GRAVITY_SMOOTH          (0.1f)
